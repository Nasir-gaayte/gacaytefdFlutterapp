...
class QadoPage extends StatefulWidget {
  const QadoPage({super.key});

  @override
  State<QadoPage> createState() => _QadoPageState();
}

class _QadoPageState extends State<QadoPage> {
  @override
  Widget build(BuildContext context) {
    String searchBy = 'qado';
    return Scaffold(
      drawer: Drawer(

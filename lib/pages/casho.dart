...
class CashoPage extends StatefulWidget {
  const CashoPage({super.key});

  @override
  State<CashoPage> createState() => _CashoPageState();
}

class _CashoPageState extends State<CashoPage> {
  String searchBy = 'casho';
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(255, 174, 250, 178),
      body: SafeArea(
        child: Column(
          children: [
            Container(
